            ...
            <Container fluid>
              <Navbar.Brand href="/">
                <div className="tw-flex tw-flex-row">
                  <div>
                    <img className="nav-logo" src="http://pmtrackerv2.com/images/logo.png" />
                  </div>
                  <div>
        ...
        <footer>
          <div className="footer tw-p-5">
            ...
            <div className="tw-flex tw-flex-row tw-justify-center">
              Site by&nbsp;<a href="https://starwebprogramming.com" target="_blank">StarWebProgramming.com <img className="tw-inline" src="http://pmtrackerv2.com/images/star3.png" /></a>
            </div>
            <div className="tw-flex tw-flex-row tw-justify-center">
