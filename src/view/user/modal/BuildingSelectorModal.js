        ...
        <Modal.Body>
          <div>
            ...
            <div className="tw-text-center tw-italic tw-text-gray-500">
              To Select your building, please enter your building zip code and ONE key word that in in the name of your building.<br />
              Then choose from the list of buildings that will appear below it
            </div>
            {buildings.length > 0 && (
            ...
            {buildings.length == 0 && (
              <div className="tw-text-center tw-mt-2 tw-bg-yellow-100 tw-rounded-md tw-p-2">
                No Building Records.
              </div>
            )}
          </div>
